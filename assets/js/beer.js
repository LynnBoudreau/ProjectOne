...
$("#submitButton").on("click", function (e) {
  ...
  $.get(breweryUrl)
    .then(function (response) {
      ...
      // bring the user down the page to the table and map
      $("#submitButton").attr("href", "#breweryEl");
    ...
    .catch(function (error) {
      console.log(error);
      // if the user enters a value that returns no response
      var errorMessage = $("<p>", {
        class: "error-message label-text",
      }).text("Please check the spelling of your search and try again");

      $("#breweryEl").append(errorMessage);
    });
});
